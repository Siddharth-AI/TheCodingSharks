...
export function TemplateCreamWarm({ workshop }: { workshop: WorkshopJson }) {
  ...
  function CtaBtn({
    ...
    return (
      <button
        onClick={openModal}
        className={`${full ? "w-full" : ""} group inline-flex items-center justify-center gap-3 px-8 py-4 font-extrabold uppercase tracking-widest text-white text-sm hover:scale-[1.02] active:scale-100 transition-all cta-pulse`}
        style={
          {
            backgroundColor: P,
            "--cta-shadow": `${P}55`,
      ...
      <div className="font-sans antialiased" style={{ backgroundColor: CREAM }}>
        ...
        <section
          ...
          <div className="flex flex-col justify-center px-6 py-16 sm:px-12 sm:py-20 lg:py-24 relative z-10">
            <div
              className="inline-flex items-center gap-2 px-5 py-2 mb-8 text-white text-xs font-bold uppercase tracking-widest shadow-md self-start"
            ...
            {workshop.instructor_name && (
              <div
                className="inline-flex items-center gap-3 bg-white px-5 py-3 shadow-md mb-8 self-start"
                data-reveal
                data-d3>
                {instructorImg ? (
                  <div className="w-11 h-11 overflow-hidden relative shrink-0">
                    <Image
                      src={instructorImg}
                  ...
                  <div
                    className="w-11 h-11 flex items-center justify-center text-white font-extrabold text-lg shrink-0"
                    style={{ backgroundColor: P }}>
          ...
          <div className="relative hidden lg:block" data-reveal-right>
            {workshop.youtube_url ? (
              <div className="absolute inset-0 flex items-center justify-center bg-orange-50 p-8">
                <div
                  ...
                  {showHeroVideo ? (
                    ...
                    <>
                      {(media?.hero_preview || heroBg) && (
                        <Image
                          src={media?.hero_preview ?? heroBg}
                          alt={workshop.title}
                          fill
                          className="object-cover"
                          sizes="45vw"
              ...
              <>
                ...
                <div className="absolute bottom-10 right-8 bg-white shadow-xl px-6 py-4">
            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {workshop.why_join_items.map((item, i) => (
                  <div
                    key={i}
                    className="bg-white p-5 shadow-sm flex items-start gap-4 hover:shadow-md transition-shadow"
                    data-reveal>
                    <div
                      className="w-8 h-8 flex items-center justify-center shrink-0 text-white text-sm font-bold"
                      style={{ backgroundColor: P }}>
                      {i + 1}
                    </div>
                ...
                return (
                  <div
                    ...
                    <div
                      ...
                      />
                      <div
                        className="absolute top-4 left-4 w-10 h-10 flex items-center justify-center text-white font-extrabold text-sm"
                        style={{ backgroundColor: P }}>
        ...
        {/* FEATURES */}
        <section
          className="py-12 px-4 sm:py-16 mx-2 sm:mx-4 mb-8"
          style={{ backgroundColor: P }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div
                ...
                {workshop.features_section_items.map((item, i) => (
                  <div
                    key={i}
                    className="bg-white/15 backdrop-blur p-5 border border-white/20 hover:bg-white/20 transition-all">
              ...
              <div data-reveal-right>
                <div className=" overflow-hidden aspect-4/3 relative shadow-2xl border-4 border-white/20">
                  {productImg && (
                    <Image
                      src={productImg}
                      alt="Program"
                ...
                <div className="mt-6">
                  <button
                    onClick={openModal}
                    className="w-full py-4 font-extrabold uppercase tracking-widest text-orange-600 text-sm shadow-lg hover:shadow-xl bg-white transition-all">
                    {ctaText}
                  </button>
                </div>
              </div>
        ...
        <section className="py-16 px-4" style={{ backgroundColor: CREAM_DARK }}>
          <div className="max-w-3xl mx-auto">
            ...
            {/* BEFORE block */}
            <div
              className="bg-white overflow-hidden shadow-sm border-2 border-red-100 mb-0"
              data-reveal-left>
              <div
                className="px-6 py-4 flex items-center gap-3"
                style={{ backgroundColor: "#fef2f2" }}>
                <span className="w-8 h-8 bg-red-500 text-white flex items-center justify-center font-extrabold text-sm">
                  ✗
                </span>
            ...
            <div className="flex justify-center items-center py-4" data-reveal>
              <div className="flex flex-col items-center gap-1">
                ...
                <div
                  className="w-10 h-10 flex items-center justify-center text-white font-extrabold shadow-lg"
                  style={{ backgroundColor: P }}>
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
            ...
            {/* AFTER block */}
            <div
              className="bg-white overflow-hidden shadow-sm border-2 border-orange-200"
              data-reveal-right>
              <div
                className="px-6 py-4 flex items-center gap-3"
                style={{ backgroundColor: "#fff7ed" }}>
                <span
                  className="w-8 h-8 text-white flex items-center justify-center font-extrabold text-sm"
                  style={{ backgroundColor: P }}>
                  ✓
                </span>
                <h3
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              <div className="flex justify-center" data-reveal-left>
                <div className="relative w-72 h-80 overflow-hidden shadow-2xl border-4 border-orange-200/30">
                  {instructorBg ? (
                    <Image
                      src={instructorBg}
                      alt={workshop.instructor_name ?? ""}
                ...
                {workshop.curriculum.map((lesson, i) => (
                  <div key={i} className="flex gap-6 items-start" data-reveal>
                    ...
                    <div className="hidden sm:flex flex-col items-center shrink-0">
                      <div
                        className="w-12 h-12 flex items-center justify-center text-white text-sm font-extrabold shadow-md relative z-10"
                        style={{ backgroundColor: P }}>
                        {lesson.lesson_num}
                      </div>
                    </div>
                    {/* Content */}
                    <div className="flex-1 bg-white overflow-hidden shadow-sm border border-orange-50 hover:shadow-md transition-shadow mb-0">
                      <div className="px-5 py-4 flex items-center gap-3 border-b border-orange-50">
                        <div
                          className="sm:hidden w-8 h-8 flex items-center justify-center text-white text-xs font-extrabold shrink-0"
                          style={{ backgroundColor: P }}>
                          {lesson.lesson_num}
                        </div>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          {workshop.faq.map((item, i) => (
            <div
              key={i}
              className={` overflow-hidden border-2 transition-all ${open === i ? `border-orange-300 shadow-md` : "border-orange-100 bg-white"}`}>
              <button
                ...
                <span
                  className="shrink-0 w-7 h-7 flex items-center justify-center text-white text-xs font-bold"
                  style={{ backgroundColor: P }}>
                  {open === i ? (
    ...
    <div
      ...
      <div className="border-t-2 border-orange-100 shadow-2xl px-4 py-3 bg-white">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          <button
            onClick={onCta}
            className="flex items-center gap-2 px-6 py-3 font-extrabold uppercase tracking-widest text-white text-sm shadow-lg shrink-0 hover:opacity-90 transition-opacity"
            style={{ backgroundColor: P }}>
            {ctaText}
            <svg
