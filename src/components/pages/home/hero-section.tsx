...
export function HeroSection() {
  ...
  return (
    <Section className="relative overflow-hidden min-h-svh flex flex-col justify-center bg-transparent pt-20 sm:pt-18 md:pt-28">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        ...
        <picture className="absolute bottom-0 left-0 right-0 h-[80%] z-[-2] opacity-60 mix-blend-screen pointer-events-none filter sepia-[.3] hue-rotate-[30deg] saturate-[1] brightness-[0.8] contrast-[1.2]">
          <source
            ...
            srcSet="/images/grid/ezgif_270f8b43f0c78a4f_d69c27d649.webp"
          />
          <source
            media="(max-width: 767px)"
            srcSet="/images/grid/ezgif_44a84ca6bc9243bf_29cf504620.webp"
          />
          <img
            src="/images/grid/ezgif_44a84ca6bc9243bf_29cf504620.webp"
            alt=""
      ...
      <div
        className="absolute hidden lg:flex top-[50%] right-[8%] float-icon text-white/5 pointer-events-none"
        style={{ animationDelay: "1.5s" }}>
        <Terminal size={56} strokeWidth={1} className="text-primary/20" />
      </div>
      <div
        className="absolute hidden sm:flex bottom-[5%] left-[20%] float-icon text-white/5 pointer-events-none"
        ...
        <div className="flex flex-col items-center text-center px-2 sm:px-0">
          ...
          <h1 className="animate-fade-slide-2 max-w-sm sm:max-w-3xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl text-balance font-medium tracking-tight font-heading">
            ...
            <span className="inline-flex items-center justify-center gap-2 sm:gap-4 text-primary italic font-heading opacity-90 relative mt-2 sm:mt-4 md:mt-4">
              ...
              <span className="relative z-10 inline-block text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-[68px] font-normal leading-none">
                {hero.headline3.split("—")[1]?.trim() ||
                  "Not Just Learn Coding"}
                {/* Underline SVG */}
                <span className="pointer-events-none absolute -bottom-4 sm:-bottom-5 md:-bottom-10 left-1/2 -translate-x-1/2 w-[110%] sm:w-[120%] text-primary opacity-90 drop-shadow-lg">
                  <svg
                    width="100%"
                    height="auto"
                    viewBox="4 -38 289 59"
          ...
          {/* Subheadline */}
          <div className="animate-fade-slide-3 mt-12 sm:mt-16 md:mt-18 max-w-sm sm:max-w-xl md:max-w-2xl lg:max-w-5xl">
          ...
          <div className="animate-fade-slide-5 mt-8 sm:mt-10 md:mt-16 flex flex-col gap-3 sm:gap-4 sm:flex-row sm:items-center sm:justify-center w-full sm:w-auto">
            <ButtonLink
              ...
              size="lg"
              className="group h-12 sm:h-13 md:h-14 w-full sm:w-auto rounded-full bg-primary px-7 sm:px-9 text-sm sm:text-base font-semibold text-primary-foreground shadow-[0_4px_24px_rgba(255,107,44,0.35)] hover:shadow-[0_6px_32px_rgba(255,107,44,0.45)] hover:bg-primary/90 transition-all flex items-center justify-center gap-2">
